...
var useHook = function useHook() {
  ...
  var _useState5 = (0, _react.useState)((0, _helpers.generateTimeStamp)()),
  ...
  var execute = function execute() {
    ...
    if (name && Array.isArray(array) && array.length > 0) {
      ...
      _data = array.reduce(function (acc, e) {
        return (0, _helpers.typeOf)(e) === 'object' ? _objectSpread({}, acc, _defineProperty({}, e.name || e.key, safe(getData(safe(store, ".getState()[".concat(name, "][").concat(e.key, "]")), undefined, e.initialLoaderState || false, Array.isArray(e.filter) ? e.filter : undefined), "".concat(e.query && (0, _helpers.typeOf)(e.query) === 'string' ? e.query : ''), e.default || undefined))) : _objectSpread({}, acc, _defineProperty({}, e, safe(store, ".getState()[".concat(name, "][").concat(e, "]"))));
      }, {});
    } else if (name) _data = safe(store, ".getState()[".concat(name, "]"));else _data = safe(store, ".getState()") || {};

    if (!(0, _isEqual.default)(_data, previousData["".concat(key || name, "_").concat(_key)])) {
      previousData["".concat(key || name, "_").concat(_key)] = _data;
      setData(_data);
    }
  };

  (0, _react.useEffect)(function () {
    previousData["".concat(key || name, "_").concat(_key)] = {};
...
var useActionsHook = function useActionsHook(name, actions) {
  var _useState7 = (0, _react.useState)({}),
      ...
      dispatchAction = _useState8[0],
      setDispatchAction = _useState8[1];
