...
var nullCheck = function nullCheck(Error, obj, path, def, callBack) {
  ...
  if (!obj || _typeof(obj) !== 'object' || Object.keys(obj).length === 0) {
    ...
    if (_typeof(obj) === 'object' && obj) {
      console.log(obj);
      console.log("%cRoot Object should contain minimum of one key : %c ".concat(path), 'background: #000; color: orange; font-size: 12px;', 'background: #000; color: red; font-size: 12px;');
    } else {
      console.log(obj);
