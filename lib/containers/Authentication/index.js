...
var _default = function _default(_ref) {
  ...
  return function () {
    ...
    (0, _invariant.default)((0, _conformsTo.default)({
      reducerName: reducerName
    }, shape), "(react-boilerplate-redux-saga-hoc) name: Expected a string but got ".concat((0, _helpers.typeOf)(reducerName), " "));
