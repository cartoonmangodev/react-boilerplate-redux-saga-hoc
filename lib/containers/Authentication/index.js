...
var _default = function _default(_ref) {
  var _ref$handlers = _ref.handlers,
      ...
      _ref$getDefaultConfig = _ref.getDefaultConfig,
      getDefaultConfig = _ref$getDefaultConfig === void 0 ? false : _ref$getDefaultConfig;
  return function () {
    ...
    var hoc = function hoc(WrapperComponent) {
      ...
      if (nextJS) WithHoc.getInitialProps = /*#__PURE__*/function () {
      ...
      return (0, _redux.compose)(withConnect, authenticationReducer, authenticationSaga)(WithHoc);
    };
