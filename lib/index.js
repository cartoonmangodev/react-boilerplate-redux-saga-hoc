...
var generateConstants = (function (_ref) {
  ...
  var _Object$keys$reduce = Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
    return {
      ...
      resetState: typeof dontResetOnLogout[key] === 'undefined' && newObject({}, acc.resetState, _defineProperty({}, ConvertData[generatorKey].constants[key][CALL$1], _objectSpread({
        loading: {},
        toast: {}
      }, apiEndPoints[generatorKey][key].initialData ? {
...
var useMutateReducer = function useMutateReducer() {
  var store = reactRedux.useStore();
  var dispatch = reactRedux.useDispatch();
...
var useResetState = function useResetState() {
  var dispatch = reactRedux.useDispatch();
  return function () {
    dispatch({
      type: 'RESET'
...
var useResetOnlyApiState = function useResetOnlyApiState() {
  var dispatch = reactRedux.useDispatch();
  return function () {
    dispatch({
      type: 'RESET_API'
...
exports.useResetOnlyApiState = useResetOnlyApiState;
