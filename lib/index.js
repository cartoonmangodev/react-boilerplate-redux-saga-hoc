...
function deleteIn(obj, arr) {
  ...
  function update() {
    ...
    return function () {
      ...
      return cloneObject(o, _defineProperty$1({}, arr[i], function () {
        o = o[arr[i]];
        i += 1;
        return update();
      }()));
...
function setIn(obj, arr, value) {
  ...
  function update() {
    ...
    return cloneObject(o, _defineProperty$1({}, arr[i], arr.length - 1 === i ? value : function () {
      o = o[arr[i]] || {};
      i += 1;
      return update();
    }()));
...
function updateIn(obj) {
  ...
  function update() {
    ...
    return cloneObject(o, _defineProperty$1({}, arr && arr[i], arr.length - 1 === i ? callback(o[arr[i]]) : function () {
      o = o[arr[i]] || {};
      i += 1;
      return update();
    }()));
...
var convertData = function convertData(apiEndPoints) {
  return Object.keys(apiEndPoints).reduce(function (prev, curr) {
    var constants = Object.keys(apiEndPoints[curr]).reduce(function (acc, key) {
      ...
      return newObject(acc, _defineProperty$1({}, key, (_key = {}, _defineProperty$1(_key, CALL$1, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CALL$1)), _defineProperty$1(_key, SUCCESS, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(SUCCESS)), _defineProperty$1(_key, CUSTOM, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CUSTOM)), _defineProperty$1(_key, ERROR, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(ERROR)), _defineProperty$1(_key, CANCEL$2, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CANCEL$2)), _key)));
    }, {});
    var actions = Object.keys(apiEndPoints[curr]).reduce(function (acc, key) {
      var _key2;

      return newObject(acc, _defineProperty$1({}, key, (_key2 = {}, _defineProperty$1(_key2, CALL$1, actionsHandler.call(constants[key][CALL$1])), _defineProperty$1(_key2, SUCCESS, actionsHandler.success(constants[key][SUCCESS])), _defineProperty$1(_key2, CUSTOM, actionsHandler.custom(constants[key][CUSTOM])), _defineProperty$1(_key2, ERROR, actionsHandler.error(constants[key][ERROR])), _defineProperty$1(_key2, CANCEL$2, actionsHandler.cancel(constants[key][CANCEL$2])), _key2)));
    }, {});
    var sagaConfig = Object.entries(apiEndPoints[curr]).reduce(function (acc, _ref) {
      ...
      return newObject(acc, _defineProperty$1({}, constants[key][CALL$1], {
        api: value,
    ...
    return newObject(prev, _defineProperty$1({}, curr, {
      actions: actions,
      constants: constants,
...
var generateConstants = (function (_ref) {
  ...
  var initialState = Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
    return newObject(acc, _defineProperty$1({}, ConvertData[generatorKey].constants[key][CALL$1], _objectSpread({
      loading: {},
      toast: {}
  ...
  var resetState = Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
    return !Object.keys(dontResetOnLogout || {}).includes(key) && newObject(acc, _defineProperty$1({}, ConvertData[generatorKey].constants[key][CALL$1], _objectSpread({
      loading: {},
      toast: {}
    }, apiEndPoints[generatorKey][key].initialData ? {
...
var injectSaga = (function (_ref) {
  ...
  return function (WrappedComponent) {
    ...
    _defineProperty$1(InjectSaga, "WrappedComponent", WrappedComponent);

    _defineProperty$1(InjectSaga, "contextType", reactRedux.ReactReduxContext);

    _defineProperty$1(InjectSaga, "displayName", "withSaga(".concat(WrappedComponent.displayName || WrappedComponent.name || 'Component', ")"));
...
var injectReducer = (function (_ref, createReducer) {
  ...
  return function (WrappedComponent) {
    ...
    _defineProperty$1(ReducerInjector, "WrappedComponent", WrappedComponent);

    _defineProperty$1(ReducerInjector, "contextType", reactRedux.ReactReduxContext);

    _defineProperty$1(ReducerInjector, "displayName", "withReducer(".concat(WrappedComponent.displayName || WrappedComponent.name || 'Component', ")"));
  ...
  return function () {
    return reselect.createSelector(selectAuthenticationDomain(initialState, generatorKey), function (substate) {
      return newObject(Object.keys(InitialState).reduce(function (acc, key) {
        return _objectSpread({}, acc, _defineProperty$1({}, key, substate[key]));
      }, {}), Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
        return _objectSpread({}, acc, _defineProperty$1({}, key, substate[constants[key][CALL$1]]));
      }, {}));
    });
  };
};
...
var actionConverter = function actionConverter(action, actionName, ignoreStatus, type) {
  return Object.entries(action).reduce(function (acc, _ref) {
    ...
    return ignoreStatus && ignore[type].includes(key) && acc || cloneObject(acc, _defineProperty$1({}, "".concat(actionName, "_").concat(key), bindKey.includes(key) && value.bind({}, action[CALL$1]().type) || value));
  }, {});
};
...
var deleteHandler = function deleteHandler(_ref3) {
  ...
  return function () {
    ...
    return {
      data: subKey.length > 0 ? updateIn(_objectSpread({}, data, {}, _successData, _defineProperty$1({}, subKey[0], data[subKey[0]])), subKey, function (_data) {
    ...
    return {
      data: function () {
        if (subKey.length > 0 && Array.isArray(getIn(oldData, subKey))) {
          var _oldCopyData = _objectSpread({}, oldData, {}, typeOf(successData) === 'object' ? successData : {}, _defineProperty$1({}, subKey[0], oldData[subKey[0]])); // return _oldCopyData
...
var updateHandler = function updateHandler(_ref) {
  ...
  return function () {
    ...
    return {
      data: subKey.length > 0 ? updateIn(_objectSpread({}, data, {}, typeOf(successData) === 'object' ? successData : {}, _defineProperty$1({}, subKey[0], data[subKey[0]])), subKey, function (_Data) {
        return function () {
          var index = -1;
...
var deleteKeyHandler = function deleteKeyHandler(_ref2) {
  ...
  return function () {
    ...
    return {
      data: subKey.length > 0 ? updateIn(_objectSpread({}, data, {}, successData, _defineProperty$1({}, subKey[0], data[subKey[0]])), subKey, function (_Data) {
...
var resetHandler = function resetHandler(state, newState, _ref) {
  ...
  return newObject(state, function (_ref2) {
    ...
    return _defineProperty$1({}, customType || type, newObject(Data, function (_ref3) {
      var data = _ref3.data,
          toast = _ref3.toast,
...
var filterArrayResetHandler = function filterArrayResetHandler(state, newState, action, filter) {
  ...
  return newObject(state, function (_ref5) {
    ...
    return _defineProperty$1({}, type, newObject(oldData, function () {
...
var updateData$1 = function updateData(data, successData, updateCallback, updateKey) {
  ...
  if (_typeof$2(successData) === 'object' && !Array.isArray(successData) && _typeof$2(data) === 'object' && !Array.isArray(data)) {
    return !updateKey ? data : updateKey.reduce(function (acc, key) {
      ...
      return _objectSpread({}, acc, _defineProperty$1({}, key, successData[key]));
    }, data);
  }
...
var toggleData = function toggleData(obj, keyArray) {
  return Object.keys(obj).reduce(function (acc, curr) {
    return _objectSpread({}, acc, _defineProperty$1({}, curr, keyArray.includes(curr) ? !obj[curr] : obj[curr]));
  }, {});
};
...
var dataHandler = function dataHandler(_ref) {
  ...
  return function () {
    ...
    return isMutation ? _objectSpread({
      ...
      data: function () {
        if (subKey.length > 0) {
          var _oldCopyData = _objectSpread({}, oldData, {}, _checkIsNotObject(successData) ? {} : successData, _defineProperty$1({}, subKey[0], oldData[subKey[0]]));
...
var responseErrorParser = function responseErrorParser() {
  ...
  return Array.isArray(data) && data.reduce(function (acc, curr) {
    ...
    return _objectSpread({}, acc, _defineProperty$1({}, payloadKey, message));
  }, {}) || {};
};
var commmonStateHandler = function commmonStateHandler(_ref) {
  ...
  if ((method === ON_LOADING || loader || [ON_SUCCESS, ON_ERROR].includes(method)) && !customTask || customLoader !== undefined && customTask && (Array.isArray(method) ? method : [method]).includes(ON_LOADING)) {
    if ((status || loader) && filter && filter.length > 0) State = newState(function (_ref2) {
      ...
      return _defineProperty$1({}, type || action.type, newObject(obj, filterArrayToastEmptyHandler({
      ...
      return _defineProperty$1({}, type || action.type, newObject(obj, function (_ref5) {
    ...
    if (((filter || responseFilter) && !customTask ? (filter || responseFilter).length > 0 : false) || customTask && customLoader !== undefined) State = newObject(State, function (_ref7) {
      ...
      return _defineProperty$1({}, type || action.type, newObject(obj, filterArrayloadingHandler({
      ...
      return _defineProperty$1({}, type || action.type, newObject(obj, function (_ref10) {
  ...
  Object.keys(constants).includes(type) && !customTask || customToast && customTask && (Array.isArray(method) ? method : [method]).includes(ON_TOAST)) {
    if (responseFilter && responseFilter.length > 0) State = newObject(State, function (_ref12) {
      var obj = _ref12[type];
      return _defineProperty$1({}, type, newObject(obj, filterArrayToastHandler(_objectSpread({
        statusCode: statusCode,
      ...
      var obj = _ref14[type];
      return _defineProperty$1({}, type, newObject(obj, {
        toast: _objectSpread({
...
var mapDispatchToProps = function mapDispatchToProps(actions, componentData, reducerName) {
  return function (dispatch) {
    return _objectSpread({
      ...
      return _defineProperty$1({}, "".concat(reducerName, "_hoc"), newObject(data, {
      ...
      case ON_SUCCESS:
        {
          var updatedState = newObject(DATA, function (_ref4) {
            var Data = _ref4[type];
            return _defineProperty$1({}, type, commonHandler(Data, state, type));
          });
      ...
      case ON_ERROR:
        {
          DATA = newObject(DATA, function (_ref6) {
            var Data = _ref6[type];
            return _defineProperty$1({}, type, newObject(Data, commmonErrorHandler()));
          });
          break;
        }
...
var index = (function (_ref) {
  ...
  return function () {
    ...
    var ApiEndPoints = _defineProperty$1({}, reducerName, apiEndPoints);
    ...
    var componentData = _defineProperty$1({}, "".concat(reducerName, "_hoc"), {
      reducerConstants: Object.entries(constants).reduce(function (acc, _ref3) {
        var _ref4 = _slicedToArray(_ref3, 2),
            key = _ref4[0],
            value = _ref4[1];

        return _objectSpread({}, acc, _defineProperty$1({}, key, value[commonConstants.CALL]));
      }, {}),
      constants: constants,
      initialState: initialState,
      axios: axiosInterceptors || request,
    ...
    var hoc = function hoc(WrapperComponent) {
      ...
      var mapStateToProps = reselect.createStructuredSelector(_defineProperty$1({}, "".concat(reducerName, "_data"), MakeSelectAuthenticationState()));
...
var nextStore = function nextStore(_ref) {
  ...
  return function () {
    ...
    var store = createStore(combineReducers(reducer.reduce(function (acc, e) {
      return _objectSpread({}, acc, _defineProperty$1({}, e.name, e.reducer));
...
function withReduxSaga() {
  ...
  _defineProperty$1(WrappedComponent, "displayName", "withReduxSaga(".concat(BaseComponent.displayName || BaseComponent.name || 'BaseComponent', ")"));
