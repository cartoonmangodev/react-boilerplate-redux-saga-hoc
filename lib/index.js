...
var checkKey$4 = function checkKey(key, name, dataType) {
  invariant((Array.isArray(dataType) ? dataType : [dataType]).includes(typeOf(key)), "(react-boilerplate-redux-saga-hoc)  Expected `".concat(name, "` to be a (").concat(dataType.join(' | '), ")"));
};
