...
function _sagaHandler (_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, resolve, reject, isReject, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, _ref3$payload$request5, params, query, requestAxios, _ref3$payload$request6, paramsSerializer, cancelKey, _ref3$payload$request7, axiosConfig, _ref3$payload$request8, cacheControl, _ref3$payload$request9, errorDataHandling, _ref3$payload$request10, clearDataOnError, _ref3$payload$request11, polling, _ref3$payload$request12, errorParser, _ref3$payload$request13, isResponseErrorParser, _ref3$payload$request14, Delay, _ref3$payload$request15, retry, _ref3$payload$request16, pollingCount, _ref3$payload$request17, callAfterDelay, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, cancelCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, _yield$race, cancelTask, _ref4, _ref4$response, customMethod, _loop;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 13:
            ...
            loop = false;
            _ref4 = cancelTask || {}, _ref4$response = _ref4.response;
            _ref4$response = _ref4$response === void 0 ? {} : _ref4$response;
            customMethod = _ref4$response.method;
          ...
          case 23:
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
              var action, axios, CancelToken, source, url, commonData, actionBind, request$1, _query, _url, requestData, postData, cancelTask, cacheId, _yield$race2, _postData, _cancelTask, cancelFilterTask, data, statusKey, _ref5, _ref5$data, _ref5$data$status, successStatus, _ref5$data$message, successMessage, successCallbackResponse, _yield$race3, CancelPolling, _yield$race3$successC, _successCallbackResponse, loader, cancelResponse, _ref6, _ref6$response, _customMethod, _ref7, _ref7$data, _ref7$data$status, _successStatus, _ref7$data$message, _successMessage, _yield$race4, _CancelPolling, pollingRes, _ref8, _ref8$response, _ref8$response$data, _ref8$response$data2, errorData, _ref8$response$data$s, errorStatus, _ref8$response$data$m, errorMessage, errorCallbackResponse, _yield$race5, _CancelPolling2, _yield$race5$errorCal, _errorCallbackResponse, _loader, Cancelled, _yield$race6, _CancelPolling3, _yield$race7, _CancelPolling4;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 77:
                      ...
                      _ref5 = data || {}, _ref5$data = _ref5.data;
                      _ref5$data = _ref5$data === void 0 ? {} : _ref5$data;
                      _ref5$data$status = _ref5$data.status, successStatus = _ref5$data$status === void 0 ? postData && postData.status : _ref5$data$status, _ref5$data$message = _ref5$data.message, successMessage = _ref5$data$message === void 0 ? '' : _ref5$data$message;
                      _context2.next = 83;
                    ...
                    case 106:
                      ...
                      _ref6 = cancelTask || {}, _ref6$response = _ref6.response;
                      _ref6$response = _ref6$response === void 0 ? {} : _ref6$response;
                      _customMethod = _ref6$response.method;
                    ...
                    case 128:
                      ...
                      _ref7 = data || {}, _ref7$data = _ref7.data;
                      _ref7$data = _ref7$data === void 0 ? {} : _ref7$data;
                      _ref7$data$status = _ref7$data.status, _successStatus = _ref7$data$status === void 0 ? postData && postData.status : _ref7$data$status, _ref7$data$message = _ref7$data.message, _successMessage = _ref7$data$message === void 0 ? '' : _ref7$data$message;
                      _context2.next = 134;
                      return race({
                    ...
                    case 143:
                      _context2.prev = 143;
                      _context2.t0 = _context2["catch"](56);
                      _context2.prev = 145;
                    ...
                    case 151:
                      ...
                      _ref8 = _context2.t0 || {}, _ref8$response = _ref8.response;
                      _ref8$response = _ref8$response === void 0 ? {} : _ref8$response;
                      _ref8$response$data = _ref8$response.data;
                      _ref8$response$data = _ref8$response$data === void 0 ? {} : _ref8$response$data;
                      _ref8$response$data2 = _ref8$response$data[action.api.errorDataKey || 'error'], errorData = _ref8$response$data2 === void 0 ? _context2.t0 && _context2.t0.response && _context2.t0.response.data || _context2.t0 && _context2.t0.response || '' : _ref8$response$data2, _ref8$response$data$s = _ref8$response$data.status, errorStatus = _ref8$response$data$s === void 0 ? _context2.t0 && _context2.t0.response && _context2.t0.response.data && (_context2.t0.response.data[action.api.errorStatusKey] || _context2.t0 && _context2.t0.response && _context2.t0.response.status) : _ref8$response$data$s, _ref8$response$data$m = _ref8$response$data.message, errorMessage = _ref8$response$data$m === void 0 ? _context2.t0 && _context2.t0.response && _context2.t0.response.data && _context2.t0.response.data[action.api.errorMessageKey] || _context2.t0 && _context2.t0.response && _context2.t0.response.statusText || _context2.t0 && _context2.t0.message || '' : _ref8$response$data$m;
                    ...
                    case 187:
                      _context2.prev = 187;
                      _context2.t1 = _context2["catch"](145);
              ...
              }, _loop, null, [[56, 143, 190, 208], [145, 187]]);
            });
