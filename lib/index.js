...
var convertData = function convertData(apiEndPoints) {
  return Object.keys(apiEndPoints).reduce(function (prev, curr) {
    var constants = Object.keys(apiEndPoints[curr]).reduce(function (acc, key) {
      ...
      return newObject(acc, _defineProperty({}, key, (_key = {}, _defineProperty(_key, CALL$1, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CALL$1)), _defineProperty(_key, SUCCESS, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(SUCCESS)), _defineProperty(_key, CUSTOM, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CUSTOM)), _defineProperty(_key, ERROR, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(ERROR)), _defineProperty(_key, CANCEL$2, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CANCEL$2)), _key)));
    }, {});
      ...
      case ON_SUCCESS:
        {
          ...
          if (Array.isArray(updateDataReducerKey) && updateDataReducerKey.length) {
            var _loop = function _loop(j) {
              DATA = newObject(DATA, function (_ref4) {
                var Data = _ref4[updateDataReducerKey[j] || type];
            ...
            updatedState = newObject(DATA, function (_ref6) {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 80:
                      ...
                      return _context2.delegateYield(call(successCallback, {
                        response: postData,
                        posts: data,
                        data: data.data,
                    ...
                    case 83:
                      successCallbackResponse = _context2.t0;
                    ...
                    case 113:
                      ...
                      return _context2.delegateYield(call(pollingCallback, {
                        response: data,
                        data: data && data.data,
                    ...
                    case 124:
                      ...
                      if (!(_context2.t2 && _typeof$2(_context2.t2) === 'object' && !_context2.t2.isAxiosError)) {
                        _context2.next = 128;
                        break;
                      }
                    ...
                    case 131:
                      if (resolve && typeOf(resolve) === 'function') resolve({
                        status: 'ERROR',
                        error: _context2.t2,
                        respone: _context2.t2 && _context2.t2.response
                      });
                      if (process.env.NODE_ENV === 'test') console.log(_context2.t2);
                      _ref7 = _context2.t2 || {}, _ref7$response = _ref7.response;
                      ...
                      _ref7$response$data2 = _ref7$response$data[action.api.errorDataKey || 'error'], errorData = _ref7$response$data2 === void 0 ? _context2.t2 && _context2.t2.response && _context2.t2.response.data || _context2.t2 && _context2.t2.response || '' : _ref7$response$data2, _ref7$response$data$s = _ref7$response$data.status, errorStatus = _ref7$response$data$s === void 0 ? _context2.t2 && _context2.t2.response && _context2.t2.response.data && (_context2.t2.response.data[action.api.errorStatusKey] || _context2.t2 && _context2.t2.response && _context2.t2.response.status) : _ref7$response$data$s, _ref7$response$data$m = _ref7$response$data.message, errorMessage = _ref7$response$data$m === void 0 ? _context2.t2 && _context2.t2.response && _context2.t2.response.data && _context2.t2.response.data[action.api.errorMessageKey] || _context2.t2 && _context2.t2.response && _context2.t2.response.statusText || '' : _ref7$response$data$m;
                      ...
                      return _context2.delegateYield(call(errorCallback, _objectSpread({
                        error: _context2.t2,
                        ...
                        errorParser: errorParser({
                          ...
                          errorData: errorData,
                          status: errorStatus,
                          response: _context2.t2 && _context2.t2.response,
                    ...
                    case 142:
                      if (!(axios.isCancel(_context2.t2) && action.cancel)) {
                        _context2.next = 149;
                        break;
                      }
                    ...
                    case 158:
                      ...
                      return _context2.delegateYield(call(finalCallback, {
                        type: type,
                        action: action,
                        payload: commonData,
                        Cancelled: Cancelled
