...
var convertData = function convertData(apiEndPoints) {
  return Object.keys(apiEndPoints).reduce(function (prev, curr) {
    var constants = Object.keys(apiEndPoints[curr]).reduce(function (acc, key) {
      ...
      return newObject(acc, _defineProperty$1({}, key, (_key = {}, _defineProperty$1(_key, CALL, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CALL)), _defineProperty$1(_key, SUCCESS, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(SUCCESS)), _defineProperty$1(_key, CUSTOM, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CUSTOM)), _defineProperty$1(_key, ERROR, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(ERROR)), _defineProperty$1(_key, CANCEL, "app/conatainers/".concat(curr, "/").concat(key, "_").concat(CANCEL)), _key)));
    }, {});
    var actions = Object.keys(apiEndPoints[curr]).reduce(function (acc, key) {
      var _key2;

      return newObject(acc, _defineProperty$1({}, key, (_key2 = {}, _defineProperty$1(_key2, CALL, actionsHandler.call(constants[key][CALL])), _defineProperty$1(_key2, SUCCESS, actionsHandler.success(constants[key][SUCCESS])), _defineProperty$1(_key2, CUSTOM, actionsHandler.custom(constants[key][CUSTOM])), _defineProperty$1(_key2, ERROR, actionsHandler.error(constants[key][ERROR])), _defineProperty$1(_key2, CANCEL, actionsHandler.cancel(constants[key][CANCEL])), _key2)));
    }, {});
    var sagaConfig = Object.entries(apiEndPoints[curr]).reduce(function (acc, _ref) {
      ...
      return newObject(acc, _defineProperty$1({}, constants[key][CALL], {
        api: value,
...
var generateConstants = (function (_ref) {
  ...
  var initialState = Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
    return newObject(acc, _defineProperty$1({}, ConvertData[generatorKey].constants[key][CALL], _objectSpread({
      loading: {},
      toast: {}
  ...
  var resetState = Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
    return !Object.keys(dontResetOnLogout || {}).includes(key) && newObject(acc, _defineProperty$1({}, ConvertData[generatorKey].constants[key][CALL], _objectSpread({
      loading: {},
      toast: {}
    }, apiEndPoints[generatorKey][key].initialData ? {
  ...
  return function () {
    return reselect.createSelector(selectAuthenticationDomain(initialState, generatorKey), function (substate) {
      return newObject(Object.keys(InitialState).reduce(function (acc, key) {
        ...
        return _objectSpread({}, acc, _defineProperty$1({}, key, substate[constants[key][CALL]]));
      }, {}));
    });
  };
};
...
var actionConverter = function actionConverter(action, actionName, ignoreStatus, type) {
  return Object.entries(action).reduce(function (acc, _ref) {
    ...
    return ignoreStatus && ignore[type].includes(key) && acc || cloneObject(acc, _defineProperty$1({}, "".concat(actionName, "_").concat(key), bindKey.includes(key) && value.bind({}, action[CALL]().type) || value));
  }, {});
};
