...
var generateConstants = (function (_ref) {
  ...
  var initialState = Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
    return newObject(acc, _defineProperty({}, ConvertData[generatorKey].constants[key][CALL$1], _objectSpread({
      loading: {},
      toast: {}
  ...
  var resetState = Object.keys(apiEndPoints[generatorKey]).reduce(function (acc, key) {
    return !Object.keys(dontResetOnLogout || {}).includes(key) && newObject(acc, _defineProperty({}, ConvertData[generatorKey].constants[key][CALL$1], _objectSpread({
      loading: {},
      toast: {}
    }, apiEndPoints[generatorKey][key].initialData ? {
...
var useHook = function useHook() {
  ...
  var _GetData = function _GetData() {
    ...
    var _getData = function _getData(e, isString) {
      return (typeof e.defaultDataFormat === 'boolean' ? !e.defaultDataFormat : false) ? (isString ? array : e.key) ? safe(store, ".getState()[".concat(name, "][").concat(isString ? array : e.key, "]").concat(e.query ? e.query : ''), e.default) : name ? safe(store, ".getState()[".concat(name, "]").concat(e.query ? e.query : ''), e.default) : safe(store, ".getState()".concat(e.query ? e.query : ''), e.default) : safe(getData(safe(store, ".getState()[".concat(name, "][").concat(isString ? array : e.key, "]")), e.query ? undefined : e.default || undefined, e.initialLoaderState || false, _checkFilter(e), e.dataQuery), "".concat(e.query && typeOf(e.query) === 'string' ? e.query : ''), e.query ? e.default !== undefined ? e.default : undefined : undefined);
    };
      ...
      case ON_SUCCESS:
        {
          var updatedState = newObject(DATA, function (_ref4) {
            var Data = _ref4[updateDataReducerKey || type];
