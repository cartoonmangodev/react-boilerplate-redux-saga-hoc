...
function _sagaHandler (_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, resolve, reject, isReject, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, _ref3$payload$request5, params, query, requestAxios, _ref3$payload$request6, paramsSerializer, cancelKey, _ref3$payload$request7, axiosConfig, _ref3$payload$request8, cacheControl, _ref3$payload$request9, errorDataHandling, _ref3$payload$request10, clearDataOnError, _ref3$payload$request11, polling, _ref3$payload$request12, errorParser, _ref3$payload$request13, isResponseErrorParser, _ref3$payload$request14, Delay, _ref3$payload$request15, retry, _ref3$payload$request16, pollingCount, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, cancelCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, _loop;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
              var action, axios, CancelToken, source, url, commonData, actionBind, request$1, _query, _url, requestData, postData, cancelTask, cacheId, _yield$race, _postData, _cancelTask, cancelFilterTask, data, statusKey, _ref4, _ref4$data, _ref4$data$status, successStatus, _ref4$data$message, successMessage, successCallbackResponse, _yield$race2, CancelPolling, _yield$race2$successC, _successCallbackResponse, loader, cancelResponse, _ref5, _ref5$response, customMethod, _ref6, _ref6$data, _ref6$data$status, _successStatus, _ref6$data$message, _successMessage, _yield$race3, _CancelPolling, pollingRes, _ref7, _ref7$response, _ref7$response$data, _ref7$response$data2, errorData, _ref7$response$data$s, errorStatus, _ref7$response$data$m, errorMessage, errorCallbackResponse, _yield$race4, _CancelPolling2, _yield$race4$errorCal, _errorCallbackResponse, _loader, Cancelled, _yield$race5, _CancelPolling3, _yield$race6, _CancelPolling4;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 64:
                      ...
                      cancelFilterTask = _yield$race.cancel_filter;
                    ...
                    case 87:
                      ...
                      _yield$race2$successC = _yield$race2.successCallbackResponse;
                      _successCallbackResponse = _yield$race2$successC === void 0 ? null : _yield$race2$successC;
                    ...
                    case 134:
                      ...
                      _CancelPolling = _yield$race3.cancel;
                      pollingRes = _yield$race3.pollingRes;
