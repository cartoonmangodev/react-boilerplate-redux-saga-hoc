...
var index = (function (_ref) {
  ...
  return function () {
    ...
    var stateProps = _store && _store.dispatch ? _objectSpread({}, componentData["".concat(reducerName, "_hoc")], {
      actions: redux.bindActionCreators(componentActions, _store.dispatch),
    ...
    var _useHocHook = function _useHocHook() {
      ...
      var _useState = React.useState(stateProps || _objectSpread({}, componentData["".concat(reducerName, "_hoc")], {
    ...
    var _useHocHookNextJs = function _useHocHookNextJs() {
      ...
      var _useState3 = React.useState(stateProps || _objectSpread({}, componentData["".concat(reducerName, "_hoc")], {
        actions: redux.bindActionCreators(componentActions, dispatch),
        dispatch: dispatch
      })),
