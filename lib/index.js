...
function _sagaHandler (_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, resolve, reject, isReject, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, _ref3$payload$request5, params, query, _ref3$payload$request6, paramsSerializer, cancelKey, _ref3$payload$request7, axiosConfig, _ref3$payload$request8, cacheControl, _ref3$payload$request9, errorDataHandling, _ref3$payload$request10, clearDataOnError, _ref3$payload$request11, polling, _ref3$payload$request12, errorParser, _ref3$payload$request13, isResponseErrorParser, _ref3$payload$request14, Delay, _ref3$payload$request15, retry, _ref3$payload$request16, pollingCount, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, cancelCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, _loop;
