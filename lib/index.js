...
function useStaleRefresh(fn, name) {
  ...
  var initialLoadingstate = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  var prevArgs = React.useRef(null);

  var _useState7 = React.useState(initialLoadingstate),
  ...
  React.useEffect(function () {
    ...
    toPromise(fn, args).then(function (newData) {
