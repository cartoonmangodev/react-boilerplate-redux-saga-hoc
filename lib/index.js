...
var useHook = function useHook() {
  ...
  var _GetData = function _GetData() {
    ...
    var _getData = function _getData(e, isString) {
      return (typeof e.defaultDataFormat === 'boolean' ? !e.defaultDataFormat : false) ? safe(store, ".getState()[".concat(name, "][").concat(isString ? array : e.key, "]").concat(e.query ? e.query : ''), e.default || undefined) : safe(getData(safe(store, ".getState()[".concat(name, "][").concat(isString ? array : e.key, "]")), e.query ? undefined : e.default || undefined, e.initialLoaderState || false, _checkFilter(e), e.dataQuery), "".concat(e.query && typeOf(e.query) === 'string' ? e.query : ''), e.query ? e.default !== undefined ? e.default : undefined : undefined);
    };
