...
function _sagaHandler (_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, resolve, reject, isReject, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, _ref3$payload$request5, params, query, _ref3$payload$request6, dontUpdateReducerOnSucess, requestAxios, _ref3$payload$request7, paramsSerializer, cancelKey, _ref3$payload$request8, axiosConfig, _ref3$payload$request9, cacheControl, _ref3$payload$request10, errorDataHandling, _ref3$payload$request11, clearDataOnError, _ref3$payload$request12, polling, _ref3$payload$request13, errorParser, _ref3$payload$request14, isResponseErrorParser, _ref3$payload$request15, Delay, _ref3$payload$request16, retry, _ref3$payload$request17, pollingCount, _ref3$payload$request18, callAfterDelay, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, cancelCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, _loop, _ret;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _ref3$payload$request2 = _ref3$payload$request.asyncFunction, asyncFunction = _ref3$payload$request2 === void 0 ? null : _ref3$payload$request2, _ref3$payload$request3 = _ref3$payload$request.asyncFunctionParams, asyncFunctionParams = _ref3$payload$request3 === void 0 ? null : _ref3$payload$request3, _ref3$payload$request4 = _ref3$payload$request.payload, payload = _ref3$payload$request4 === void 0 ? {} : _ref3$payload$request4, _ref3$payload$request5 = _ref3$payload$request.params, params = _ref3$payload$request5 === void 0 ? {} : _ref3$payload$request5, query = _ref3$payload$request.query, _ref3$payload$request6 = _ref3$payload$request.dontUpdateReducerOnSucess, dontUpdateReducerOnSucess = _ref3$payload$request6 === void 0 ? false : _ref3$payload$request6, requestAxios = _ref3$payload$request.axios, _ref3$payload$request7 = _ref3$payload$request.paramsSerializer, paramsSerializer = _ref3$payload$request7 === void 0 ? {
              arrayFormat: 'brackets'
            } : _ref3$payload$request7, cancelKey = _ref3$payload$request.cancelKey, _ref3$payload$request8 = _ref3$payload$request.axiosConfig, axiosConfig = _ref3$payload$request8 === void 0 ? {} : _ref3$payload$request8, _ref3$payload$request9 = _ref3$payload$request.useCache, cacheControl = _ref3$payload$request9 === void 0 ? false : _ref3$payload$request9, _ref3$payload$request10 = _ref3$payload$request.errorDataHandling, errorDataHandling = _ref3$payload$request10 === void 0 ? true : _ref3$payload$request10, _ref3$payload$request11 = _ref3$payload$request.clearDataOnError, clearDataOnError = _ref3$payload$request11 === void 0 ? false : _ref3$payload$request11, _ref3$payload$request12 = _ref3$payload$request.polling, polling = _ref3$payload$request12 === void 0 ? false : _ref3$payload$request12, _ref3$payload$request13 = _ref3$payload$request.errorParser, errorParser = _ref3$payload$request13 === void 0 ? false : _ref3$payload$request13, _ref3$payload$request14 = _ref3$payload$request.defaultErrorParser, isResponseErrorParser = _ref3$payload$request14 === void 0 ? false : _ref3$payload$request14, _ref3$payload$request15 = _ref3$payload$request.delay, Delay = _ref3$payload$request15 === void 0 ? 8000 : _ref3$payload$request15, _ref3$payload$request16 = _ref3$payload$request.retry, retry = _ref3$payload$request16 === void 0 ? 0 : _ref3$payload$request16, _ref3$payload$request17 = _ref3$payload$request.pollingCount, pollingCount = _ref3$payload$request17 === void 0 ? 'unlimited' : _ref3$payload$request17, _ref3$payload$request18 = _ref3$payload$request.callAfterDelay, callAfterDelay = _ref3$payload$request18 === void 0 ? false : _ref3$payload$request18, rest = _objectWithoutProperties$1(_ref3$payload$request, ["asyncFunction", "asyncFunctionParams", "payload", "params", "query", "dontUpdateReducerOnSucess", "axios", "paramsSerializer", "cancelKey", "axiosConfig", "useCache", "errorDataHandling", "clearDataOnError", "polling", "errorParser", "defaultErrorParser", "delay", "retry", "pollingCount", "callAfterDelay"]), _ref3$payload$callbac = _ref3$payload.callback;
            ...
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
              ...
              return _regeneratorRuntime.wrap(function _loop$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 157:
                      _context2.prev = 157;
                      _context2.t0 = _context2["catch"](68);
                      _context2.prev = 159;
                    ...
                    case 186:
                      if (!(AxiosDefault.isCancel(_context2.t0) && action.cancel)) {
                        _context2.next = 193;
                        break;
                      }
                    ...
                    case 201:
                      _context2.prev = 201;
                      _context2.t1 = _context2["catch"](159);
              ...
              }, _loop, null, [[68, 157, 204, 222], [159, 201]]);
            });
  ...
  return function () {
    ...
    var _useHocHook = function _useHocHook() {
      ...
      if (!isMounted[reducerName] || isInjected.current || inject) {
        ...
        useInjectSaga(injectSagaConfig, inject); // eslint-disable-next-line react-hooks/rules-of-hooks
