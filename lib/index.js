...
var useQuery = function useQuery() {
  ...
  var execute = React.useCallback(function (state) {
    ...
    if (!isEqual(_data, _queryData)) {
      ...
      previousData.set(_key, _data && _typeof$2(_data) === 'object' ? JSON.parse(JSON.stringify(_data)) : _data);
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
              var action, axios, CancelToken, source, url, commonData, actionBind, request$1, _query, _url, requestData, postData, cancelTask, cacheId, _yield$race, _postData, _cancelTask, cancelFilterTask, data, statusKey, _ref4, _ref4$data, _ref4$data$status, _successStatus, _ref4$data$message, successMessage, successCallbackResponse, loader, cancelResponse, _ref5, customMethod, _ref6, _ref6$data, _ref6$data$status, _successStatus2, _ref6$data$message, _successMessage, pollingRes, _ref7, _ref7$response, _ref7$response$data, _ref7$response$data2, errorData, _ref7$response$data$s, errorStatus, _ref7$response$data$m, errorMessage, errorCallbackResponse, _loader, Cancelled, _yield$race2, CancelPolling;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 76:
                      ...
                      _ref4$data$status = _ref4$data.status, _successStatus = _ref4$data$status === void 0 ? postData && postData.status : _ref4$data$status, _ref4$data$message = _ref4$data.message, successMessage = _ref4$data$message === void 0 ? '' : _ref4$data$message;
                      _context2.next = 82;
                      return action.success = action.success.bind({}, _successStatus, successMessage);
                    ...
                    case 116:
                      if (typeof successCallback === 'function' && !cancelTask) {
                        successCallback({
                          response: postData,
                          status: successStatus // isError: true
                          // error: postData,
                          // response: postData,
                          // isError: true,
                    ...
                    case 119:
                      ...
                      _ref6$data$status = _ref6$data.status, _successStatus2 = _ref6$data$status === void 0 ? postData && postData.status : _ref6$data$status, _ref6$data$message = _ref6$data.message, _successMessage = _ref6$data$message === void 0 ? '' : _ref6$data$message;
                      _context2.next = 125;
                      return call(pollingCallback, {
                        response: data,
                        data: data && data.data,
                        message: _successMessage,
                        status: _successStatus2,
                        count: count
                      });
...
var index = (function (_ref) {
  ...
  return function () {
    ...
    var _useHocHookNextJs = function _useHocHookNextJs() {
      ...
      var _useState3 = React.useState(_objectSpread({}, componentData["".concat(reducerName, "_hoc")], {
        actions: redux.bindActionCreators(componentActions, dispatch),
        dispatch: dispatch
      })),
