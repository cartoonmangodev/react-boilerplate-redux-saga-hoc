...
var updateHandler = function updateHandler(_ref) {
  ...
  return function () {
    ...
    return {
      data: subKey.length > 0 ? updateIn(_objectSpread(_objectSpread(_objectSpread({}, data), typeOf(successData) === 'object' && !dontUpdateResponseData ? successData : {}), {}, _defineProperty({}, subKey[0], data[subKey[0]])), subKey, function (_Data) {
        return function () {
          var index = -1;
...
var toPromiseAllFunction = function toPromiseAllFunction() {
  ...
  return function () {
    ...
    return Promise.all(actions.map(function (action, i) {
      return new Promise(function (resolve, reject) {
        return action(_objectSpread(_objectSpread({}, (typeOf(config) === 'object' ? config : config[i] && config[i].config) || defaultConfig.config || {}), {}, {
          resolve: resolve,
          reject: reject,
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 97:
                      ...
                      _context2.next = 101;
                      return effects.race({
                        successCallbackResponse: effects.call(successCallback, {
                          response: postData,
                          posts: data,
                          data: data.data,
                    ...
                    case 158:
                      ...
                      _context2.next = 170;
                      return effects.race({
                        errorCallbackResponse: effects.call(errorCallback, _objectSpread(_objectSpread({
                          error: _context2.t0,
...
var index = (function (_ref) {
  ...
  return function () {
    ...
    var _useHocHook = function _useHocHook() {
      ...
      var dispatch = reactRedux.useDispatch();
      if (!stateProps || isDevelopment) stateProps = dispatch ? _objectSpread(_objectSpread({}, componentData["".concat(reducerName, "_hoc")]), {}, {
    ...
    var _useHocHookNextJs = function _useHocHookNextJs() {
      ...
      var dispatch = reactRedux.useDispatch();
      if ((!nextStateProps || isDevelopment) && dispatch) nextStateProps = _objectSpread(_objectSpread({}, componentData["".concat(reducerName, "_hoc")]), {}, {
        actions: redux.bindActionCreators(componentActions, dispatch),
        dispatch: dispatch
      });
