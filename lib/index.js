                  ...
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 147:
                      if (errorCallbackResponse) {
                        if (typeOf(commonData._errortask) === 'boolean' && commonData._errortask) commonData._errortask = true;else if (typeOf(errorCallbackResponse) === 'object' && Object.keys(errorCallbackResponse).length > 0) {
