...
var index = (function (_ref) {
  ...
  return function () {
    ...
    var _useHocHook = function _useHocHook() {
      ...
      } else if ((!isMounted[reducerName] || isInjected.current || inject) && !nextJS) {
        if (!isMounted[reducerName] && isDevelopment) showInjectedMessage(reducerName);
      ...
      if ((!stateProps || isDevelopment) && dispatch) {
        stateProps = _objectSpread(_objectSpread({}, componentData["".concat(reducerName, "_hoc")]), {}, {
