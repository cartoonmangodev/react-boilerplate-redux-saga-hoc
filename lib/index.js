...
var executeTask$2 = function executeTask(_ref, _Data) {
  ...
  return updateCallback ? updateCallback(_updatedData, successData) || _Data : _updatedData;
};
            ...
            var _loop = function _loop(k) {
              ...
              if (Array.isArray(_updateDataReducerKey) && _updateDataReducerKey.length > 0) {
                ...
                DATA = newObject(DATA, function (_ref6) {
                  ...
                  return _defineProperty({}, _updateDataReducerKey || type, _commonHandler(Data, state, type));
                });
              }
            };
...
function _sagaHandler (_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, resolve, reject, isReject, _ref3$payload$dontUpd, dontUpdateReducer, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, _ref3$payload$request5, params, query, _ref3$payload$request6, dontUpdateReducerOnSucess, _ref3$payload$request7, dontUpdateReducerOnError, requestAxios, _ref3$payload$request8, paramsSerializer, cancelKey, _ref3$payload$request9, axiosConfig, _ref3$payload$request10, cacheControl, _ref3$payload$request11, errorDataHandling, _ref3$payload$request12, clearDataOnError, _ref3$payload$request13, polling, _ref3$payload$request14, errorParser, _ref3$payload$request15, isResponseErrorParser, _ref3$payload$request16, Delay, _ref3$payload$request17, retry, _ref3$payload$request18, pollingCount, _ref3$payload$request19, callAfterDelay, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, cancelCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, POLLING_RESPONSE_DATA, _loop, _ret;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
              var action, axios, CancelToken, source, url, commonData, actionBind, request$1, _query, _url, requestData, postData, cancelTask, _yield$race, _cancelTask, cacheId, _yield$race2, _postData, _cancelTask2, cancelFilterTask, data, statusKey, _ref4, _ref4$data, _ref4$data$status, _successStatus, _ref4$data$message, _successMessage, successCallbackResponse, _yield$race3, CancelPolling, _yield$race3$successC, _successCallbackResponse, loader, cancelResponse, _ref5, _ref5$response, customMethod, _ref6, _ref6$response, _ref6$response$data, _ref6$response$data2, errorData, _ref6$response$data$s, errorStatus, _ref6$response$data$m, errorMessage, errorCallbackResponse, _yield$race4, _CancelPolling2, _yield$race4$errorCal, _errorCallbackResponse, _loader, Cancelled, _yield$race5, _CancelPolling3, _yield$race6, _CancelPolling4, _yield$race7, _CancelPolling, pollingRes;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 91:
                      ...
                      _ref4$data$status = _ref4$data.status, _successStatus = _ref4$data$status === void 0 ? postData && postData.status : _ref4$data$status, _ref4$data$message = _ref4$data.message, _successMessage = _ref4$data$message === void 0 ? '' : _ref4$data$message;
                      _context2.next = 97;
                      return action.success = action.success.bind({}, _successStatus, _successMessage);
                    ...
                    case 158:
                      ...
                      _ref6$response$data2 = _ref6$response$data[action.api.errorDataKey || 'error'], errorData = _ref6$response$data2 === void 0 ? _context2.t0 && _context2.t0.response && _context2.t0.response.data || _context2.t0 && _context2.t0.response || '' : _ref6$response$data2, _ref6$response$data$s = _ref6$response$data.status, errorStatus = _ref6$response$data$s === void 0 ? _context2.t0 && _context2.t0.response && _context2.t0.response.data && (_context2.t0.response.data[action.api.errorStatusKey] || _context2.t0 && _context2.t0.response && _context2.t0.response.status) : _ref6$response$data$s, _ref6$response$data$m = _ref6$response$data.message, errorMessage = _ref6$response$data$m === void 0 ? _context2.t0 && _context2.t0.response && _context2.t0.response.data && _context2.t0.response.data[action.api.errorMessageKey] || _context2.t0 && _context2.t0.response && _context2.t0.response.statusText || _context2.t0 && _context2.t0.message || '' : _ref6$response$data$m;
