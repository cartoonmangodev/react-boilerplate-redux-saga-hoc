...
function _sagaHandler (_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, resolve, reject, isReject, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, _ref3$payload$request5, params, query, _ref3$payload$request6, paramsSerializer, _ref3$payload$request7, axiosConfig, _ref3$payload$request8, cacheControl, _ref3$payload$request9, errorDataHandling, _ref3$payload$request10, clearDataOnError, _ref3$payload$request11, polling, _ref3$payload$request12, errorParser, _ref3$payload$request13, isResponseErrorParser, _ref3$payload$request14, Delay, _ref3$payload$request15, retry, _ref3$payload$request16, pollingCount, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, cancelCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, _loop;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 63:
                      ...
                      _postData2 = _yield$race.posts;
                      _cancelTask = _yield$race.cancel;
                      cancelTask = _cancelTask;
                      postData = _objectSpread({}, _postData2);
                    ...
                    case 115:
                      if (typeof errorCallback === 'function' && !cancelTask) {
                        errorCallback({
                          ...
                          response: _postData,
                          isError: true,
                          isNetworkError: _postData && _postData.message === 'Network Error'
                        });
                      }
