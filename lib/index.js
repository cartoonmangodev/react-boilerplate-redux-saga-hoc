...
var toPromiseAllFunction = function toPromiseAllFunction() {
  ...
  return function () {
    ...
    if (typeOf(config) !== 'null' && typeOf(config) !== 'undefined' && typeOf(config) !== 'array') checkKeyWithMessage(config, 'object', "toPromise() : Expected a config (first parameter) to be an Array or Object");
