...
function _sagaHandler (_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, resolve, reject, isReject, _ref3$payload$dontUpd, dontUpdateReducer, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, _ref3$payload$request5, params, query, _ref3$payload$request6, dontUpdateReducerOnSucess, _ref3$payload$request7, dontUpdateReducerOnError, requestAxios, _ref3$payload$request8, paramsSerializer, cancelKey, _ref3$payload$request9, axiosConfig, _ref3$payload$request10, cacheControl, _ref3$payload$request11, errorDataHandling, _ref3$payload$request12, clearDataOnError, _ref3$payload$request13, polling, _ref3$payload$request14, errorParser, _ref3$payload$request15, isResponseErrorParser, _ref3$payload$request16, Delay, _ref3$payload$request17, retry, _ref3$payload$request18, pollingCount, _ref3$payload$request19, callAfterDelay, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, cancelCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, _loop, _ret;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 151:
                      ...
                      _CancelPolling = _yield$race4.cancel;
                      pollingRes = _yield$race4.pollingRes;
                      if (_CancelPolling) loop = false; // const pollingRes = yield call(pollingCallback, {
                      //   response: data,
                      //   data: data && data.data,
                      //   message: successMessage,
                      //   status: successStatus,
                    ...
                    case 205:
                      _context2.prev = 205;
                      _context2.t1 = _context2["catch"](162);
              ...
              }, _loop, null, [[70, 160, 208, 227], [162, 205]]);
            });
  ...
  return function () {
    ...
    var _useHocHook = function _useHocHook() {
      ...
      var _useState = React.useState(stateProps),
          _useState2 = _slicedToArray(_useState, 1),
          state = _useState2[0]; // const [state] = useState(
      //   stateProps || {
