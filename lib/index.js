...
var resetReducerHandler = function resetReducerHandler() {
  return function () {
    ...
    var data = _ref$data.data,
        ...
        statusCode = _ref.statusCode,
        rest = _objectWithoutProperties$1(_ref, ["data", "statusCode"]);
...
var useMutation = function useMutation(reducerName) {
  ...
  var _callback = React.useCallback(function (_ref23) {
    ...
    checkKey$2(type, 'key', 'string'); // const regex = `app\/containers\/${reducerName}\/+.*?_CALL`;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
              ...
              return _regeneratorRuntime.wrap(function _loop$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 121:
                      if (!(cancelTask && (source && typeof source.cancel === 'function' || rest.onCancelTask || controller && typeof controller.abort === 'function'))) {
                        _context2.next = 138;
                        break;
                      }

                      _context2.next = 124;
                      return (rest.onCancelTask || source && source.cancel === 'function' && source.cancel || controller && typeof controller.abort === 'function' && controller.abort || function () {})();
                    ...
                    case 147:
                      ...
                      if (resolve && typeOf(resolve) === 'function') {
                        if (cancelTask && (source && source.cancel === 'function' || controller && typeof controller.abort === 'function')) {
                          resolve({
                            status: 'CANCELLED',
                            response: null,
                            data: null
                    ...
                    case 152:
                      _context2.prev = 152;
                      _context2.t0 = _context2["catch"](72);
                      _context2.prev = 154;
                    ...
                    case 197:
                      _context2.prev = 197;
                      _context2.t1 = _context2["catch"](154);
              ...
              }, _loop, null, [[72, 152, 200, 224], [154, 197]]);
            });
...
var showDepricatedMessage = function showDepricatedMessage(reducerName) {
  var DEPRICATED_MESSAGE = "<======= \"".concat(reducerName, " Reducer\" (react-boilerplate-redux-saga-hoc) Sorry! This package is depricated.Please use some other package ====>");
...
var index = (function (_ref) {
  ...
  return function () {
    ...
    var _useHocHook = function _useHocHook() {
      ...
      } else if (!isMounted[reducerName] || isInjected.current || inject || isDevelopment) {
        if (!isMounted[reducerName] && isDevelopment) console.log("===== Successfully Injected Reducer - ".concat(reducerName, " ====="));
      ...
      var dispatch = reactRedux.useDispatch();
      if (!stateProps || isDevelopment) stateProps = dispatch ? _objectSpread({}, componentData["".concat(reducerName, "_hoc")], {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 5;
                    return WrapperComponent[getInitialPropsKey](_objectSpread({}, props, {}, mapDispatchToProps(componentActions, componentData, reducerName // eslint-disable-next-line prettier/prettier
                    )(store.dispatch)));
    ...
    var _useHocHookNextJs = function _useHocHookNextJs() {
      ...
      var dispatch = reactRedux.useDispatch();
      if ((!nextStateProps || isDevelopment) && dispatch) nextStateProps = _objectSpread({}, componentData["".concat(reducerName, "_hoc")], {
        actions: redux.bindActionCreators(componentActions, dispatch),
        dispatch: dispatch
      });
