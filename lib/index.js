      ...
      case ON_SUCCESS:
        {
          ...
          DATA = updateStateCallback && (!_errortask || excuteUpdateStateCallbackOnError) ? updateStateCallback({
            state: updatedState,
            data: successData,
            type: 'SUCCESS'
      ...
      case ON_ERROR:
        {
          ...
          DATA = updateStateCallback && (excuteUpdateStateCallbackOnError || updateStateCallbackOnError) ? updateStateCallback({
            state: _updatedState,
            data: successData,
            type: 'ERROR'
