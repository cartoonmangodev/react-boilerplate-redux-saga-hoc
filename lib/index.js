      ...
      case ON_SUCCESS:
        {
          ...
          DATA = updateStateCallback && !_errortask ? updateStateCallback({
            state: updatedState,
            data: successData,
            type: 'SUCCESS'
      ...
      case ON_ERROR:
        {
          ...
          DATA = updateStateCallback && updateStateCallbackOnError ? updateStateCallback({
            state: _updatedState,
            data: successData,
            type: 'ERROR'
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      ...
                      axios$1 = action.api && action.api.axios || requestAxios || axiosInterceptors || request;
                    ...
                    case 61:
                      _context2.next = 63;
                      return race({
                        posts: typeof asyncFunction === 'function' ? call.apply(void 0, [asyncFunction].concat(_toConsumableArray(Array.isArray(pollingRequestConfig && pollingRequestConfig.asyncFunctionParams || asyncFunctionParams) ? pollingRequestConfig && pollingRequestConfig.asyncFunctionParams || asyncFunctionParams : []))) : call(axios$1, _objectSpread({}, request$1, {}, pollingRequestConfig && pollingRequestConfig.axiosConfig || axiosConfig)),
                    ...
                    case 155:
                      if (!(axios$1.isCancel(_context2.t0) && action.cancel)) {
                        _context2.next = 162;
                        break;
                      }
