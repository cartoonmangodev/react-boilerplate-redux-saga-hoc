...
var previousData = [];
var useQueryIndexArray = [];
var initialRender = [];
var previousCallbackData = [];
var previousDependencyArrayData = [];
var isPreviousDependencyArrayCheckPassed = [];
var useQuery = function useQuery() {
  ...
  var _useState = React.useState(useQueryIndexArray.push(null)),
  ...
  var execute = React.useCallback(function (state) {
    ...
    var _queryData = previousData[_key];
    var isPassed = isPreviousDependencyArrayCheckPassed[_key];
    ...
    if ((config && config.dependencyArray && !Array.isArray(config.dependencyArray)) && !isPassed) {
      ...
      if (!isPassed && config.dependencyArray.filter(function (e) {
        ...
        var _previous = previousDependencyArrayData[_key];
  ...
  React.useEffect(function () {
    ...
    return function () {
      ...
      previousDependencyArrayData[_key] = null; // previousData.delete(_key);
  ...
  var equalityCheckFunction = React.useCallback(function (e, f) {
    ...
    if ((!_isEqual || initialRender[_key]) && typeof callbackSuccess === 'function') {
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop() {
              var action, axios, CancelToken, source, url, commonData, actionBind, request$1, _query, _url, requestData, postData, cancelTask, cacheId, _yield$race, _postData, _cancelTask, cancelFilterTask, data, statusKey, _ref4, _ref4$data, _ref4$data$status, successStatus, _ref4$data$message, successMessage, successCallbackResponse, loader, cancelResponse, _ref5, customMethod, _ref6, _ref6$data, _ref6$data$status, _successStatus, _ref6$data$message, _successMessage, pollingRes, _ref7, _ref7$response, _ref7$response$data, _ref7$response$data2, errorData, _ref7$response$data$s, errorStatus, _ref7$response$data$m, errorMessage, errorCallbackResponse, _loader, Cancelled, _yield$race2, CancelPolling;
              ...
              return _regeneratorRuntime.wrap(function _loop$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 151:
                      errorCallbackResponse = _context2.sent;
              ...
              }, _loop, null, [[55, 131, 173, 188], [133, 170]]);
            });
