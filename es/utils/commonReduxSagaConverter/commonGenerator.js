...
function _default(_ref2) {
  ...
  function commonGenerator(_ref3) {
    var _ref3$payload, _ref3$payload$request, _ref3$payload$request2, asyncFunction, _ref3$payload$request3, asyncFunctionParams, _ref3$payload$request4, payload, params, query, _ref3$payload$request5, paramsSerializer, _ref3$payload$request6, axiosConfig, _ref3$payload$request7, polling, _ref3$payload$request8, errorParser, _ref3$payload$request9, isResponseErrorParser, _ref3$payload$request10, Delay, _ref3$payload$request11, retry, _ref3$payload$request12, pollingCount, rest, _ref3$payload$callbac, successCallback, errorCallback, logoutCallback, finalCallback, pollingCallback, restCallback, restPayload, type, loop, count, pollingRequestConfig, _loop;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            } : _ref3$payload$request5, _ref3$payload$request6 = _ref3$payload$request.axiosConfig, axiosConfig = _ref3$payload$request6 === void 0 ? {} : _ref3$payload$request6, _ref3$payload$request7 = _ref3$payload$request.polling, polling = _ref3$payload$request7 === void 0 ? false : _ref3$payload$request7, _ref3$payload$request8 = _ref3$payload$request.errorParser, errorParser = _ref3$payload$request8 === void 0 ? false : _ref3$payload$request8, _ref3$payload$request9 = _ref3$payload$request.responseErrorParser, isResponseErrorParser = _ref3$payload$request9 === void 0 ? false : _ref3$payload$request9, _ref3$payload$request10 = _ref3$payload$request.delay, Delay = _ref3$payload$request10 === void 0 ? 8000 : _ref3$payload$request10, _ref3$payload$request11 = _ref3$payload$request.retry, retry = _ref3$payload$request11 === void 0 ? 0 : _ref3$payload$request11, _ref3$payload$request12 = _ref3$payload$request.pollingCount, pollingCount = _ref3$payload$request12 === void 0 ? 'unlimited' : _ref3$payload$request12, rest = _objectWithoutProperties(_ref3$payload$request, ["asyncFunction", "asyncFunctionParams", "payload", "params", "query", "paramsSerializer", "axiosConfig", "polling", "errorParser", "responseErrorParser", "delay", "retry", "pollingCount"]), _ref3$payload$callbac = _ref3$payload.callback;
