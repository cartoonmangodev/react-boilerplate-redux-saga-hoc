...
export default function (_ref2) {
  ...
  function* commonGenerator(_ref3) {
    ...
    var resolve = _ref3$payload.resolve,
    ...
    var successCallback = _ref3$payload$callbac.successCallback,
        ...
        restPayload = _objectWithoutPropertiesLoose(_ref3$payload, ["resolve", "reject", "request", "callback"]),
        type = _ref3.type;
    ...
    var _loop = function* _loop() {
      ...
      try {
        ...
        if (data) {
          ...
          if (typeof successCallback === 'function') successCallbackResponse = yield call(successCallback, {
            response: postData,
            posts: data,
            data: data.data,
