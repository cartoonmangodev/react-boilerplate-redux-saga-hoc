...
var toPromise = function toPromise(action) {
  ...
  if ((0, _helpers.typeOf)(config) !== 'null' || (0, _helpers.typeOf)(config) !== 'undefined') checkKeyWithMessage(config, 'object', "toPromise() : Expected a config (second parameter) to be object");
