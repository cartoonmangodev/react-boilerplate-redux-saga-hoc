(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-redux'), require('redux'), require('http'), require('https'), require('url'), require('assert'), require('stream'), require('tty'), require('util'), require('os'), require('zlib'), require('domain'), require('redux-saga/effects'), require('redux-saga')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-redux', 'redux', 'http', 'https', 'url', 'assert', 'stream', 'tty', 'util', 'os', 'zlib', 'domain', 'redux-saga/effects', 'redux-saga'], factory) :
  (global = global || self, factory(global.ReactQuery = {}, global.React, global.reactRedux, global.redux, global.http, global.https, global.url, global.assert, global.stream, global.tty, global.util, global.os, global.zlib, global.domain$1, global.effects, global.createSagaMiddleware));
}(this, (function (exports, React, reactRedux, redux, http, https, url, assert, stream, tty, util, os, zlib, domain$1, effects, createSagaMiddleware) { 'use strict';
  ...
  domain$1 = domain$1 && Object.prototype.hasOwnProperty.call(domain$1, 'default') ? domain$1['default'] : domain$1;
  ...
  */
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 50:
                        ...
                        _context2.next = 54;
                        return effects.race({
                          posts: typeof asyncFunction === 'function' ? effects.call.apply(void 0, [asyncFunction].concat(_toConsumableArray(Array.isArray(pollingRequestConfig && pollingRequestConfig.asyncFunctionParams || asyncFunctionParams) ? pollingRequestConfig && pollingRequestConfig.asyncFunctionParams || asyncFunctionParams : []))) : effects.call(axios, _objectSpread2({}, request$1, {}, pollingRequestConfig && pollingRequestConfig.axiosConfig || axiosConfig)),
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _context.next = 9;
            return effects.put(action.success(_objectSpread2({
              data: successData
            }, restSuccessData)));
  ...
  var index$1 = (function (_ref) {
    ...
    return function () {
      ...
      var _useHocHook = function _useHocHook() {
        ...
        var _React$useState = React__default.useState(_objectSpread2({}, componentData["".concat(reducerName, "_hoc")], {
      ...
      var hoc = function hoc(WrapperComponent) {
        ...
        var withConnect = reactRedux.connect(mapStateToProps, mapDispatchToProps(componentActions, componentData, reducerName));
        ...
        return (useHook || _useHook ? redux.compose(reactRedux.connect(null, mapDispatchToProps(componentActions, componentData, reducerName)), authenticationReducer, authenticationSaga) : redux.compose(withConnect, authenticationReducer, authenticationSaga))(WithHoc);
      };
  ...
  exports.withRedux = withRedux$1;
  exports.withReduxSaga = withReduxSaga;

  Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=react-boilerplate-redux-saga-hoc.development.js.map
